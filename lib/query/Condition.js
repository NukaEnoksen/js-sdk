...
function objForEach(it, object, cb) {
  for (let key in object) {
    if (Object.prototype.hasOwnProperty.call(object, key)) {
      it = cb.call(it, key, object[key]);
    }
  }
...
Object.assign(Condition, /** @lends query.Condition<T>.prototype */ {
  ...
  equal(field, value) {
    if (typeof field == 'object') {
      return objForEach(this, field, (key, value) => this._addFilter(key, null, value));
    }
    return this._addFilter(field, null, value);
  },

  /**
   * Adds equal filters to the field. All other other filters on the field will be discarded
   * @param {Object.<string, *>} fields The fields to filter
   * @return {query.Filter<T>} The resulting Query
   * @instance
